...
class ElementoUpdateRequest extends FormRequest
{
    /**
    ...
    {
        $filtro_elemento = $this->route('filtro_elemento');
        $rules = [
            'codigo' => [
                'required',
                'string',
                'max:16',
                Rule::unique('filtro_codificacion', 'codigo')->ignore($filtro_elemento->id_filtro),
                Rule::unique('espec_aireautomotriz', 'codigo'),
                Rule::unique('espec_aireindustrial', 'codigo'),
                Rule::unique('espec_combustiblelinea', 'codigo'),
                Rule::unique('espec_elemento', 'codigo')->ignore($filtro_elemento),
