...
return new class extends Migration
{
    ...
    {
        Schema::create('espec_aireautomotriz', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('sincronizado',11)->nullable()->autoIncrement(false)->default(0);
    ...
    {
        Schema::dropIfExists('espec_aireautomotriz');
    }
};
