...
return new class extends Migration
{
    ...
    {
        Schema::create('espec_combustiblelinea', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('diametroext', $precision = 6, $scale = 2)->default(0.00)->unsigned();
            $table->decimal('altura', $precision = 6, $scale = 2)->default(0.00)->unsigned();
            $table->decimal('entrada', $precision = 6, $scale = 2)->default(0.00)->unsigned();
            $table->decimal('salida', $precision = 6, $scale = 2)->default(0.00)->unsigned();
    ...
    {
        Schema::dropIfExists('espec_combustiblelinea');
    }
};
