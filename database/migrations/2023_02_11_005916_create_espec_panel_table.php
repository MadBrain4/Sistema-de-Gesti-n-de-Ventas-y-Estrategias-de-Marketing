...
return new class extends Migration
{
    ...
    {
        Schema::create('espec_panel', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('largo', $precision = 6, $scale = 2)->default(0.00)->unsigned();
            $table->decimal('ancho', $precision = 6, $scale = 2)->default(0.00)->unsigned();
    ...
    {
        Schema::dropIfExists('espec_panel');
    }
};
