...
<section class="about_tabla_espe">
    <section class="about-if_tabla_esp">
        ...
        <div class="tex_tablas">
            <a href="{{ route('jet-filter.catalogo.aireindustrial.crear') }}" class="boton_nuevo">Nuevo</a>
        </div>
    </section>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Código Buscar</th>
                    <th>Tipo</th>
                    <th>Diámetro Ext 1</th>
                    <th>Diámetro Ext 2</th>
...
<script>
    ...
    function getData(pagina){
        ...
        fetch('/jetfilter/catalogo/aireindustrial/cargar', {
            method: 'POST',
            body: formData,
        })
