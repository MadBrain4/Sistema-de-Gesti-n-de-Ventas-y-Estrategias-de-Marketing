<x-Arriba_JetFilter>
    <x-slot name="title">
        Nuevo Producto de Aplicación Liviana
    </x-slot>
</x-Arriba_JetFilter>
...
<section class="about_tabla_espe">
    <section class="about-if_tabla_esp">
        <div class="tex_tablas">
            <p>Crear Producto de Aplicación Liviana</p>
        </div>
        <div class="tex_tablas">
    ...
    <section class="es_tabla">
        <div class="tex_tablas">
            <form action="{{ route('jet-filter.catalogo.aplicacion_liviano.store') }}" method="POST" id="nuevo-formulario" class="formulario_aire" enctype="multipart/form-data">
                <table class="tabla_edi">
                    ...
                    <tr> 
                        <td class="b_td"> <input class="boton" type="submit" value="Enviar" name="aplicacion_liviano"></td>
