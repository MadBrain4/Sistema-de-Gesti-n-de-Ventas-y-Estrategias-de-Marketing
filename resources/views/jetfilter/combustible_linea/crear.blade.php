<x-Arriba_JetFilter>
    <x-slot name="title">
        Nuevo Producto de Combustible en Linea
    </x-slot>
</x-Arriba_JetFilter>
...
<section class="about_tabla_espe">
    <section class="about-if_tabla_esp">
        <div class="tex_tablas">
            <p>Crear Producto y Especificaciones de Combustible en Linea</p>
        </div>
        <div class="tex_tablas">
    ...
    <section class="es_tabla">
        <div class="tex_tablas">
           <form action="{{ route('jet-filter.catalogo.combustiblelinea.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <table class="tabla_edi">
                    ...
                    <tr>
                        <th>Entrada:</th>
                        <td>
                            <input type="number" id="entrada" name="entrada" min="0" step=".01" required>
                        </td>
                    </tr>
                    <tr>
                        <th>Salida:</th>
                        <td>
                        <input type="number" id="salida" name="salida" min="0" step=".01" required>
                        </td>
                    </tr>
                    <tr>
                        <th>Detalle 1:</th>
                    ...
                    <tr> 
                        <td class="b_td"> 
                            <input class="boton" type="submit" value="Enviar" name="combustible_linea">
                        </td>
                        <td class="b_td">  
