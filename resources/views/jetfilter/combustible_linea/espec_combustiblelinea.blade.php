...
<section class="about_tabla_espe">
    <section class="about-if_tabla_esp">
        <div class="tex_tablas">
            <p>Combustible en Línea</p>
        </div>
        <div class="tex_tablas">
            <a href="{{ route('jet-filter.catalogo.combustiblelinea.crear') }}" class="boton_nuevo">Nuevo</a>
        </div>
    </section>
...
<script>
    ...
    function getData(pagina){
        ...
        fetch('/jetfilter/catalogo/combustiblelinea/cargar', {
            method: 'POST',
            body: formData,
        })
