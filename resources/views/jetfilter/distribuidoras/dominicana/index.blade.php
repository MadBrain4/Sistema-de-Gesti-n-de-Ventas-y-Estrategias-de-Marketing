...
<x-Arriba_JetFilter>
    <x-slot name="title">
        Distribuidoras - República Dominicana
    </x-slot>
</x-Arriba_JetFilter>
...
<section class="about_tabla_espe">
    <section class="about-if_tabla_esp">
        <div class="tex_tablas">
            <p>Distribuidoras - República Dominicana</p>
        </div>
        <div class="tex_tablas">
            <a href="{{ route('jet-filter.distribuidoras.dominicana.nuevo') }}" class="boton_nuevo">Nuevo</a>
        </div>
    </section>
...
<script>
    ...
    function getData(pagina){
        ...
        formData.append('pais', 'Republica Dominicana')
