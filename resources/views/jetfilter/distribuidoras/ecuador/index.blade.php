...
<section class="about_tabla_espe">
    <section class="about-if_tabla_esp">
        <div class="tex_tablas">
            <p>Distribuidoras - Ecuador</p>
        </div>
        <div class="tex_tablas">
            <a href="{{ route('jet-filter.distribuidoras.ecuador.nuevo') }}" class="boton_nuevo">Nuevo</a>
        </div>
    </section>
