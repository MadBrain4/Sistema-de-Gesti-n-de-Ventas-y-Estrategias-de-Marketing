<x-ArribaJetFilter>
    <x-slot name='title'>
        Crear Nueva Distribuidora - Venezuela
    </x-slot>
</x-ArribaJetFilter>
...
<section class="about_tabla_espe">
    <x-Encabezado>
        ...
        <x-slot name="nuevo">
            <a href="{{ route('jet-filter.distribuidoras.venezuela') }}" class="boton">Atras</a>
        </x-slot>
    </x-Encabezado>
    ...
    <section class="about_tabla_edi">
        <div class="tex_tablas">
            <form action="{{ route('jet-filter.distribuidoras.store') }}" method="POST" class="formulario_aire" enctype="multipart/form-data">
                <input type="hidden" name="pais" value="Venezuela" required>
